...
class AutoScalingText extends React.Component {
  ...
  componentDidUpdate() {
    ...
    const actualScale = currentWidth / actualWidth
      ...
      <div className="calculator">
        ...
        <div className="calculator-keypad">
          ...
          <div className="operator-keys">
            <CalculatorKey className="key-divide" onPress={() => this.calc('/')}>÷</CalculatorKey>
            <CalculatorKey className="key-multiply" onPress={() => this.calc('*')}>×</CalculatorKey>
            <CalculatorKey className="key-subtract" onPress={() => this.calc('-')}>−</CalculatorKey>
            <CalculatorKey className="key-add" onPress={() => this.calc('+')}>+</CalculatorKey>
            <CalculatorKey className="key-equals" onPress={() => this.calc('=')}>=</CalculatorKey>
          </div>
        </div>
      </div>
    )
